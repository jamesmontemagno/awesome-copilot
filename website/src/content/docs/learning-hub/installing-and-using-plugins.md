...
| **Extensions** | IDE extensions installable via the plugin marketplace (v1.0.62+). Plugins can also ship Copilot-native extensions under a `com.github.copilot/extensions/` directory for deeper platform integration. | `extensions/` or `com.github.copilot/extensions/` |
