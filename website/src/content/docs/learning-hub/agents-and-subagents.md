...
Yes. As of v1.0.72, **multi-turn subagents are always enabled** — you can send follow-up messages to a subagent while it is still running. This lets you steer or clarify mid-task without waiting for it to finish. Previously this capability was behind a feature flag.
