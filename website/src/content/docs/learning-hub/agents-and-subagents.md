...
As of v1.0.71, the default maximum subagent nesting depth has been lowered from 6 to 4 to curb runaway recursive delegation. Usage-based billing users can still adjust `subagents.maxDepth` (up to 128) via `/settings` or `settings.json`.
