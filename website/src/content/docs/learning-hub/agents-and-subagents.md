...
Yes, as of v1.0.72, **multi-turn subagents are always enabled** in the CLI. You can send follow-up messages to a subagent that is still running — for example, to steer it mid-task or provide additional context — without waiting for it to complete first.
